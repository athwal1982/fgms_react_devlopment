          ...
          <div className={BizClass.TicketDetail}>
            <h4>
              ...
              {selectedData.HasDocument && selectedData.HasDocument === 1 ? (
                <MdAttachFile
                  onClick={() => toggleFileViewerModal(Config.BaseUrl + selectedData.AttachmentPath)}
          ...
          <p>
            ...
            <span>
              ...
              <MdOutlineContentCopy
                style={{ color: "#000000", paddingLeft: "5px", fontSize: "18px", cursor: "pointer" }}
                        ...
                        <div className={BizClass.ChatTitle}>
                          <p>
                            ...
                            {data.HasDocument && data.HasDocument === 1 ? (
                              <MdAttachFile
                                onClick={() => toggleFileViewerModal(Config.BaseUrl + data.AttachmentPath)}
                                style={{ cursor: "pointer", color: "#000000" }}
                              />
                            ) : null}{" "}
                          </p>
