...
export const excelUploadData = async (formData) => {
  try {
    const result = await apiCallingWithFormData(formData, APIEndpoints.ReplyOnMultipleTickets.ExcelUpload);
    return result;
  } catch (error) {
    console.log(error);
    return {
...
export const uploadTicketSelectData = async (formData) => {
  try {
    const requestData = {
      main: {
        ...formData,
    ...
    const result = await ApiCalling(requestData, APIEndpoints.ReplyOnMultipleTickets.UploadTicketSelect);
    return result;
  } catch (error) {
    console.log(error);
    return {
