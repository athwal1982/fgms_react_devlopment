...
const CreateTraining = ({props}) => {
  ...
  const isHighlightedDate = (date) => {
    return existingTrainingDates.find(training => training.date === date);
  };

  const handleMouseEnter = (date) => {
    const training = isHighlightedDate(date);
    if (training) {
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <input
                ...
                className={isHighlightedDate(trainingDate) ? "highlighted-date" : ""}
                onMouseEnter={() => handleMouseEnter(trainingDate)}
